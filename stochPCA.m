...
%%
function stochPCA(dataname,methods,data,k,iter_end,eta,lambda,RST,beta,itr_st)
        ...
        for method=methods
            ...
            if(~exist(fname,'file') || RST)
                ...
                for iter=L(1)+1:L(2)
                    ...
                    if(strcmp(method{1},'sgd'))
                        UU=Gram_Schmidt(U);
                    elseif(sum(strcmp(method{1},{'msg','l2rmsg','l1rmsg', 'l21rmsg'})))
                ...
                save(fname,'runtime','U','S','objV','objVtune','seq','rk');
            end
        end
